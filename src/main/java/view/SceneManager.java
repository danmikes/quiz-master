...
public class SceneManager {
  ...
  public void showEditQuizScene(Course course, Quiz quiz) {
    FXMLLoader loader = getScene("/view/fxml/editQuiz.fxml");
    EditQuizController controller = loader.getController();
    controller.setup(course, quiz);
  }

  public void showNewQuizScene(Course course) {
    FXMLLoader loader = getScene("/view/fxml/newQuiz.fxml");
    NewQuizController controller = loader.getController();
    controller.setup(course);
  }

  public void showNewQuestionScene(Course course, Quiz quiz) {
    FXMLLoader loader = getScene("/view/fxml/newQuestion.fxml");
    NewQuestionController controller = loader.getController();
    controller.setup(course, quiz);
  }

//  public void showEditQuestionScene(Quiz quiz, Question question) {
//    FXMLLoader loader = getScene("/view/fxml/editQuestion.fxml");
//    NewQuizController controller = loader.getController();
